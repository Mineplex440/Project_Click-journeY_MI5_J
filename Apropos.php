    ...
    ?>
        ...
        <div class="div-apropos">
            <fieldset class="fieldset-apropos">
                ...
                <p class="para">Nous sommes un groupe d'étudiants de CY-Tech qui proposons un service de voyage à destinations des ornithologue qui cherche à voir des oiseaux exotique.</p>
            </fieldset>
        </div>
